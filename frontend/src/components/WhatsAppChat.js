...
export default function WhatsAppChat() {
  ...
  const filteredSwaps = swaps.filter((swap) => {
    ...
    const otherUser =
      swap.sender._id === user._id ? swap.receiver : swap.sender;
    ...
    if (swap.latestMessage?.content?.toLowerCase().includes(searchLower))
      return true;
  ...
  const otherUser = selectedSwap
    ? selectedSwap.sender._id === user._id
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-gray-600 mb-3 text-sm">
                  {searchTerm
                    ...
                    : "Start chatting with your swap partners."}
                </p>
              </div>
            ) : (
                        ...
                        <div className="flex items-center justify-between mb-0.5">
                          ...
                          <div className="flex items-center gap-1 flex-shrink-0">
                            ...
                            <span className="text-xs text-gray-400">
                              {formatDistanceToNow(new Date(swap.updatedAt), {
                                addSuffix: true,
                              })}
                            </span>
                          </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-600 truncate">
                      ...
                      :{" "}
                      <span className="font-medium text-blue-600">
                        {Array.isArray(selectedSwap.offeredSkill)
                          ? selectedSwap.offeredSkill.join(", ")
                          : selectedSwap.offeredSkill}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    <span
                      className={`text-xs px-1.5 py-0.5 rounded-full font-medium ${
                        selectedSwap.difficultyLevel === "Beginner"
                          ? "bg-green-100 text-green-700"
                          : selectedSwap.difficultyLevel === "Intermediate"
                          ? "bg-yellow-100 text-yellow-700"
                          : selectedSwap.difficultyLevel === "Advanced"
