        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-3">
            ...
            <div>
              ...
              <p className="text-secondary-600 mt-2">Sign in to your SkillSwap account</p>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-secondary-600">
              ...
              <a href="/auth/register" className="font-semibold text-primary-600 hover:text-primary-700 transition-colors">
                Create one now
              </a>
            </p>
          </div>
